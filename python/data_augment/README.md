...
- **I forgor to overlap-add with triangle windows sized to the new-peak spacing.** I forgot this trick, and tried Hann windows sized to `2·input_period` and — surprise — smeared the output amplitude by 25% at every output peak on any non-unit shift. If you've read pre-2002 PSOLA papers and you're wondering why their audio samples sound like a dying modem, that's why.
